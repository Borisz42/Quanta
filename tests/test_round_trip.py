...
def test_cross_lingual_english_hungarian_gold_set_20(pipeline):
    ...
    gold_pairs = [
        ("A golden retriever bit the mailman in the garden.", "Egy golden retriever a kertben megharapta a postást."),
        ...
        ("A cat chased a dog.", "Egy macska kergetett egy kutyát."),
        ("The person saw a garden.", "Az ember látott egy kertet."),
        ("A dog ran into the house.", "Egy kutya a házba futott."),
        ("The cat was in the house.", "A macska a házban volt."),
        ("A person touched a rock.", "Egy ember érintett egy követ."),
        ("The dog walked from the garden.", "A kutya a kertből sétált."),
        ("A mailman saw a dog.", "Egy postás látott egy kutyát."),
        ("A dog did not chase a cat.", "Egy kutya nem kergetett egy macskát."),
        ("The cat ran rapidly.", "A macska gyorsan futott."),
        ("Every dog chased a ball.", "Minden kutya kergetett egy labdát."),
        ("Two dogs were in the garden.", "Két kutya a kertben volt."),
        ("A dog lived in the garden.", "Egy kutya a kertben élt."),
        ("The rock was big.", "A kő nagy volt."),
        ("Did a person see a cat?", "Vajon egy ember látott egy macskát?"),
        ("The mailman walked into the garden.", "A postás a kertbe sétált."),
        ("A person saw a cat in the house.", "Egy ember a házban látott egy macskát."),
